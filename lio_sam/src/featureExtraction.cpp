...
public:
    ...
    void calculateSmoothness() {
        ...
        for (int i = 5; i < cloudSize - 5; i++) {
            float diffRange =
                cloudInfo.pointRange[i - 5] + cloudInfo.pointRange[i - 4] + cloudInfo.pointRange[i - 3] + cloudInfo.pointRange[i - 2] + cloudInfo.pointRange[i - 1] - cloudInfo.pointRange[i] * 10 + cloudInfo.pointRange[i + 1] + cloudInfo.pointRange[i + 2] + cloudInfo.pointRange[i + 3] + cloudInfo.pointRange[i + 4] + cloudInfo.pointRange[i + 5];
        ...
        for (int i = 0; i < N_SCAN; i++) {
            ...
            for (int j = 0; j < 6; j++) {
                ...
                std::sort(cloudSmoothness.begin() + sp,
                          cloudSmoothness.begin() + ep, by_value());
